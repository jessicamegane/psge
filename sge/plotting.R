...
library(tidyr)
library(viridis)
wd = "C:/Users/jessicamegane/Downloads/clean_repo/psge/sge/"
setwd(wd)
  ...
  for (path in paths) {
    ...
    if (properties$alg_type == "psge") {
      ...
      tmp_data = read.csv(tempfile, 
                          header = F,
                          sep = ";")
      colnames(tmp_data)[1:8]=c("gen","best_fit","genot","phenot","gram","fit_mean","fit_sd","best_error_test")
...
# TODO: do this to the PCFG probabilities
