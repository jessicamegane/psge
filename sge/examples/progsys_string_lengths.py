...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "progsys", ("Compare String Lengths" + "-Embed.txt"))
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Compare String Lengths/Train.txt"
    dataset_test = "resources/progsys/Compare String Lengths/Test.txt"
    grammar = "grammars/progsys/Compare String Lengths.bnf"
