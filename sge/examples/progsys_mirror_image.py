...
class ProgSys():
    ...
    def get_data(self, train, test, grammar):
        ...
        embed_file = path.join("grammars", "progsys", ("Mirror Image" + "-Embed.txt"))
...
if __name__ == '__main__':
    import sge
    dataset_train = "resources/progsys/Mirror Image/Train.txt"
    dataset_test = "resources/progsys/Mirror Image/Test.txt"
    grammar = "grammars/progsys/Mirror Image.bnf"
