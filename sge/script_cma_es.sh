...
printf '%s\n' "${SEEDS[@]}" | parallel -j $MAX_JOBS \
    ...
    --genotype_init fixed \
    --n_best_genotype 250 \
    --experiment_name experiments_500_gen/cma_es_n_best_250_sgef_eda_elite_1/bostonhousing 
...
printf '%s\n' "${SEEDS[@]}" | parallel -j $MAX_JOBS \
    ...
    --genotype_init fixed \
    --n_best_genotype 250 \
    --experiment_name experiments_500_gen/cma_es_n_best_250_psge_eda_elite_1_nbest1/bostonhousing 
