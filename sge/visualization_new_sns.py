...
if __name__ == "__main__":
    ...
    problem="Median"
    paths = [
        ("PSGE", "standard/progsys/Median/1.0/"),
        # ("subtree up 2 down 4", "subtree_dependent/progsys/Median/nbest_5/up_2/down_4/1.0/"),
        # ("subtree up 3 down 4", "subtree_dependent/progsys/Median/nbest_5/up_3/down_4/1.0/"),
        # ("subtree up 2 down 4 0.1" , "subtree_dependent/progsys/Median/nbest_5/up_2/down_4/0.1/"),
        # ("subtree up 3 down 4 0.1" , "subtree_dependent/progsys/Median/nbest_5/up_3/down_4/0.1/"),
        # ("subtree up 4 down 4 0.1" , "subtree_dependent/progsys/Median/nbest_5/up_4/down_4/0.1/"),
        # ("subtree up 3 down 4 0.1" , "subtree_dependent/progsys/Median/nbest_5/up_3/down_4/0.1/"),

        # ("subtree up 5 down 5 0.1", "subtree_dependent/progsys/Median/nbest_5/up_5/down_5/0.1/"),
        # ("subtree up 5 down 6 0.1", "subtree_dependent/progsys/Median/nbest_5/up_5/down_6/0.1/"),
        ("subtree up 4 down 5 0.1", "subtree_dependent/progsys/Median/nbest_5/up_4/down_5/0.1/"),
        # ("subtree up 4 down 6 0.1", "subtree_dependent/progsys/Median/nbest_5/up_4/down_6/0.1/"),
        # ("subtree up 5 down 4 0.1", "subtree_dependent/progsys/Median/nbest_5/up_5/down_4/0.1/"),
        # ("subtree up 5 down 5 0.1", "subtree_dependent/progsys/Median/nbest_5/up_5/down_5/0.1/"),
        # ("subtree up 5 down 6 0.1", "subtree_dependent/progsys/Median/nbest_5/up_5/down_6/0.1/"),
        ("copsge 2.5 0.25", "/home/lei2016/jessicac/co-psge/sge/copsge/progsys/Median/2.5/0.25/"),
        ("copsge 5.0 0.5", "/home/lei2016/jessicac/co-psge/sge/copsge/progsys/Median/5.0/0.5/"),

    ]

    problem = "Mirror-image"
    paths= [
        ("PSGE" ,"standard/progsys/Mirror-Image/1.0/"),
        # ("subtree up 4 down 5 0.1", "subtree_dependent/progsys/Mirror-Image/nbest_5/up_4/down_5/0.1/"),
        ("subtree up 4 down 6 0.1", "subtree_dependent/progsys/Mirror-Image/nbest_5/up_4/down_6/0.1/"),
        # ("subtree up 4 down 7 0.1", "subtree_dependent/progsys/Mirror-Image/nbest_5/up_4/down_7/0.1/"),
        # ("subtree up 4 down 8 0.1", "subtree_dependent/progsys/Mirror-Image/nbest_5/up_4/down_8/0.1/"),
        # ("subtree up 5 down 5 0.1", "subtree_dependent/progsys/Mirror-Image/nbest_5/up_5/down_5/0.1/"),
        # ("subtree up 5 down 6 0.1", "subtree_dependent/progsys/Mirror-Image/nbest_5/up_5/down_6/0.1/"),
        # ("subtree up 5 down 7 0.1", "subtree_dependent/progsys/Mirror-Image/nbest_5/up_5/down_7/0.1/"),
        # ("subtree up 5 down 8 0.1", "subtree_dependent/progsys/Mirror-Image/nbest_5/up_5/down_8/0.1/"),
        # ("subtree up 6 down 9 0.1", "subtree_dependent/progsys/Mirror-Image/nbest_5/up_6/down_9/0.1/"),
        # ("subtree up 4 down 3 0.1", "subtree_dependent/progsys/Mirror-Image/nbest_5/up_4/down_3/0.1/"),
        # ("subtree up 4 down 4 0.1", "subtree_dependent/progsys/Mirror-Image/nbest_5/up_4/down_4/0.1/"),
        # ("subtree up 3 down 4 0.1", "subtree_dependent/progsys/Mirror-Image/nbest_5/up_3/down_4/0.1/"),
        # ("subtree up 3 down 5 0.1", "subtree_dependent/progsys/Mirror-Image/nbest_5/up_3/down_5/0.1/"),
        # ("subtree up 3 down 6 0.1", "subtree_dependent/progsys/Mirror-Image/nbest_5/up_3/down_6/0.1/"),
        # ("subtree up 2 down 3" , "subtree_dependent/progsys/Mirror-Image/nbest_5/up_2/down_3/0.1/"),
        # ("subtree up 2 down 4" , "subtree_dependent/progsys/Mirror-Image/nbest_5/up_2/down_4/0.1/"),
        # ("subtree up 2 down 5" , "subtree_dependent/progsys/Mirror-Image/nbest_5/up_2/down_5/0.1/"),
        # ("subtree up 2 down 6" , "subtree_dependent/progsys/Mirror-Image/nbest_5/up_2/down_6/0.1/"),
        # ("subtree up 2 down 7" , "subtree_dependent/progsys/Mirror-Image/nbest_5/up_2/down_7/0.1/"),
    
        ("copsge 2.5 0.25", "/home/lei2016/jessicac/co-psge/sge/copsge/progsys/Mirror-Image/2.5/0.25/"),
        ("copsge 5.0 0.5", "/home/lei2016/jessicac/co-psge/sge/copsge/progsys/Mirror-Image/5.0/0.5/"),
    ...
    problem="11multiplexer"
    paths=[
        ("PSGE", "standard/11multiplexer/1.0/"),
        ("depedn cmmon force best diff worst diff", "common_subtree/11multiplexer/dependent_force_best_different_worst_different/1.0/"),
        ("PSGE previous rule","common_subtree/11multiplexer/previous_rule_only/1.0/")
    ]
