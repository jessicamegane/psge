...
# These defaults can be overridden without editing the script, for example:
# MAX_JOBS=8 RESULTS_ROOT=/media/storage/experiments ./script_5000_generations.sh
MAX_JOBS="${MAX_JOBS:-16}"
NUM_RUNS="${NUM_RUNS:-30}"
RESULTS_ROOT="${RESULTS_ROOT:-experiments_2500_gen}"
...
PARAMETERS_FILE="parameters/auto_params_5000.yaml"
MAX_DEPTHS=(10 15)

# Format: name|algorithm method|search strategy|learning strategy|elitism
CONFIGURATIONS=(
    "sge_eda|sgef|eda|none|1"
    "sge_standard|sgef|standard|none|100"
